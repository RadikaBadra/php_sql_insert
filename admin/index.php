...
<body class="container d-flex flex-column h-100">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark bg-success p-3">
            <div class="container">
                <a class="navbar-brand" href="#">Pemrograman Web: 2101020017 Radika Badragitha</a>
        ...
        <div class="row h-100">
            <div class="col-md-2 p-3 collapse" id="collapseExample">
                <div class="p-3 text-white bg-dark border border-dark">
                    <a class="text-white text-decoration-none" href="index.php?page=kategori">Kategori</a>        
                </div>
                <div class="p-3 text-white bg-dark border border-dark mt-2">
                    <a class="text-white text-decoration-none" href="index.php?page=produk">Produk</a>        
                </div>
                <div class="p-3 text-white bg-dark border border-dark mt-2">
                    <a class="text-white text-decoration-none" href="index.php?page=pesanan">Pesanan</a>       
                </div>
            </div>
